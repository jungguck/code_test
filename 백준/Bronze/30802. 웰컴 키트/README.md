...
여기서 [S, M, L, XL, XXL, XXXL] 는 리스트입니다.
...
for size in ... 는 리스트 안 값을 하나씩 꺼내서 size에 넣습니다.
...
즉 1부터 들어가는 것이 아니라 리스트 값이 들어갑니다.
...
3️⃣ 그래서 range()가 필요한 이유

만약 숫자를 증가시키는 반복을 하고 싶다면
